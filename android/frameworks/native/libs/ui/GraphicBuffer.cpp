...
int GraphicBuffer::setVideoBufferInfo(uint32_t videoAddr0, uint32_t videoAddr1, uint32_t videoAddr2, uint32_t videoAddr3, uint32_t videoAddr4, uint32_t videoAddr5, unsigned int videoFormat){
...
int GraphicBuffer::setDitInfo(uint32_t interlace,uint32_t topFieldFirst) {
