...
public final class DisplayManagerService extends IDisplayManager.Stub {
    ...
    @Override // Binder call
    public int getDisplayParameter(int displaytype, int cmd, int para0, int para1) {
        int displayId = 0;
        ...
        if (displayId >= 0) {
            return Surface.getDisplayParameter(displayId, cmd, para0, para1);
        } else {
            return -1;
        }
    }
    ...
    public int setDisplayParameter(int displaytype, int cmd, int para0, int para1, int para2) {
        ...
        if (displayId >= 0) {
            return Surface.setDisplayParameter(displayId, cmd, para0, para1, para2);
        } else {
            return -1;
        }
    }
    ...
    {
        return setDisplayParameter(Display.TYPE_HDMI ,
