...
final class ProcessList {
    ...
    private void updateOomLevels(int displayWidth, int displayHeight, boolean write) {
        ...
        Slog.e("XXXXXXX", "******************************* MINFREE: " + memString + " adj: "+ adjString);
        if( SystemProperties.getBoolean("ro.config.low_ram", false) ) {
             memString.delete(0, memString.length());
             memString.append("1024,2048,3072,4096,5120,6144");//*4 = mOomMinFree
             mOomMinFree[0] = 4096;
             mOomMinFree[1] = 8096;
             mOomMinFree[2] = 12288;
             mOomMinFree[3] = 16384;
             ...
             adjString.append("1,3,5,7,9,15");
             mOomAdj[0] = VISIBLE_APP_ADJ;
             mOomAdj[1] = BACKUP_APP_ADJ;
             mOomAdj[2] = SERVICE_ADJ;
             mOomAdj[3] = PREVIOUS_APP_ADJ;
             mOomAdj[4] = CACHED_APP_MIN_ADJ;
             mOomAdj[5] = CACHED_APP_MAX_ADJ;
        }
        Slog.e("XXXXXXX", "******************************* MINFREE: " + memString + " adj: "+ adjString);
        if (write) {
