...
public class AudioManager {
    ...
    /** @hide show volume bar when setStreamMute, special case! */
    public static final int SHOW_MUTE_UI = 0x10000;
    ...
    */
    public void setAudioDeviceActive(ArrayList<String> dev, String state){
		...
		if (enablePassThrough && state.equals(AUDIO_OUTPUT_ACTIVE)) {
			DisplayManager dm = new DisplayManager(mContext);
			boolean hdmi = dm.getDisplayOutputType(Display.TYPE_BUILT_IN)
