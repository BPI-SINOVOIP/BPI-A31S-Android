...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
        ...
        /**
         * Author :chenjd@allwinnertech<br/>
        ...
        public static final String[] SETTINGS_TO_BACKUP = {
            ...
            /* add by chenjd. start {{----------------------------------- */
            /* 2014-2-24 */
            /* record the audio manager policy */
            AUDIO_MANAGE_POLICY,
    ...
    public static final class Global extends NameValueTable {
       ...
       public static final String OVERLAY_DISPLAY_DEVICES = "overlay_display_devices";
         ...
         */
        public static boolean putInt(ContentResolver cr, String name, int value) {
            if(WIFI_SCAN_ALWAYS_AVAILABLE.equals(name)) {
                if ("true".equals(SystemProperties.get("ro.wifi.usb"))) {
                    //force disable WIFI_SCAN_ALWAYS_AVAILABLE for usb wifi to cut down power consumption;
                    return putString(cr, name, Integer.toString(0));
                }
            }
