...
public final class DisplayManager {
    ...
    private static final int DISPLAY_CMD_SETPERCENT              = 0x07;
    ...
    public int setDisplayOutputMode(int displaytype, int outtype, int outmode) {
        return mGlobal.setDisplayParameter(displaytype, DISPLAY_CMD_SETOUTPUTMODE,
                outtype, outmode, 0);
    }
    ...
    public int setDisplayPercent(int displaytype, int percent) {
        return mGlobal.setDisplayParameter(displaytype, DISPLAY_CMD_SETPERCENT,
                percent, 0, 0);
    }
