		...
		if (hardwareAccelerated)
 		{
			final int N = 4;
 			...
 			substr[0] = "softmaker.applications.planmaker";
 			substr[1] = "softmaker.applications.presentations";
 			substr[2] = "com.square_enix.million_cn";
 			substr[3] = "air.com.forthedream.dreamworks";
 			pckname = mView.getContext().getPackageName();
 			for (int i = 0; i < N; i++) {
 				int index = pckname.indexOf(substr[i]);
 				if (index != -1) {
