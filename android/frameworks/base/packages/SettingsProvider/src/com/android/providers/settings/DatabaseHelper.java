...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void loadSystemSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            loadStringSetting(stmt, Settings.System.DISPLAY_OUTPUT_FORMAT,
    ...
    private void loadSecureSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            loadBooleanSetting(stmt, Settings.Secure.WIFI_CHEAT_ON,
                    R.bool.def_wifi_cheat_on);
    ...
    private void loadGlobalSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            /* add by Gary. start {{----------------------------------- */
            /* 2013-6-2 */
            /* init other defalut value of the ethernet */
            loadBooleanSetting(stmt, Settings.Global.ETHERNET_CONF,
                    R.bool.def_ethernet_conf);
            loadStringSetting(stmt, Settings.Global.ETHERNET_IFNAME,
