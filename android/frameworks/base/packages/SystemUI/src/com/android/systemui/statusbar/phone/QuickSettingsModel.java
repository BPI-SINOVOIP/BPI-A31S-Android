...
class QuickSettingsModel implements BluetoothStateChangeCallback,
    ...
    private QuickSettingsTileView mVolumeAdjustTile;
    private RefreshCallback mVolumeAdjustCallback;
    private State mVolumeAdjustState = new State();
    ...
    void addVolumeAdjustTile(QuickSettingsTileView view, RefreshCallback cb) {
        mVolumeAdjustTile = view;
        mVolumeAdjustCallback = cb;
        refreshVolumeAdjustTile();
    }
    
    void refreshVolumeAdjustTile(){
        Resources r = mContext.getResources();
        mVolumeAdjustState.label = r.getString(R.string.quick_settings_VolumeAdjust_label);
        mVolumeAdjustCallback.refreshView(mVolumeAdjustTile, mVolumeAdjustState);
    }
}
