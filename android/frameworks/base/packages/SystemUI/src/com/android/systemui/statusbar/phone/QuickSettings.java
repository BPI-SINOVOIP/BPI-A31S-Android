...
class QuickSettings {
    ...
    private void setupQuickSettings() {
        ...
        addPrivateTiles(mContainerView, inflater);
            ...
            mModel.addRSSITile(rssiTile, new NetworkActivityCallback() {
                ...
                public void refreshView(QuickSettingsTileView view, State state) {
                   ...
                   if(SystemProperties.get("ro.sw.embeded.telephony").equals("false")){
                    	view.setVisibility(rssiState.signalIconId != R.drawable.ic_qs_signal_no_signal ? View.VISIBLE : View.GONE);
                   }                    
                }
            });
    ...
    private void addPrivateTiles(ViewGroup parent, LayoutInflater inflater) {
        // ScreenShot tile
        ...
        // Volume Adjust tile
        final QuickSettingsBasicTile volumeTile = new QuickSettingsBasicTile(mContext);
        ...
        mModel.addVolumeAdjustTile(volumeTile,
                new QuickSettingsModel.BasicRefreshCallback(volumeTile));
    ...
    private ServiceConnection mScreeShotConnection;
    
    private void takeScreenShot(){
        ComponentName mComponent = new ComponentName("com.android.systemui",
        ...
        ServiceConnection mSC = new ServiceConnection(){
            public void onServiceConnected(ComponentName name, IBinder service){
                if(mScreeShotConnection!=this)
                    return;
                Messenger mSend = new Messenger(service);
                Message msg = Message.obtain(null, 1);
               
                Handler mH = new Handler(mHandler.getLooper()){
                    public void handleMessage(Message msg) {
                        mContext.unbindService(mScreeShotConnection);
                        mScreeShotConnection = null;
                    }
                };
                
                msg.replyTo = new Messenger(mH);
                msg.arg1 = msg.arg2 = 1;
        ...
        mScreeShotConnection = mSC;
        
        mContext.bindServiceAsUser(mIntent, mScreeShotConnection, Context.BIND_AUTO_CREATE, UserHandle.CURRENT);
    }
