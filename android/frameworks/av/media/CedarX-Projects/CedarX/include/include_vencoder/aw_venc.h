...
typedef struct Vencoder
{
	void *context;
	int  (*ioctrl)(void *encoder, VENCODER_COMMAND_TYPE cmd, void* param);
}Vencoder;

Vencoder *Vencoder_Create();
void Vencoder_Destroy(void *encoder);
