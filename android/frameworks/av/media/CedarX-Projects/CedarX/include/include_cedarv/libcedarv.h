...
extern "C" {
    ...
    typedef enum CEDARV_PIXEL_FORMAT
    {
        ...
        CEDARV_PIXEL_FORMAT_PLANNER_NV21		  = 0x15,
    ...
    {
        s32                     id;                     //* picture id assigned by outside, decoder do not use this field;
                                
		s32						width;					//* width of picture content;
		s32						height;					//* height of picture content;
        u32                     top_offset;				//* display region top offset;
        u32                     left_offset;			//* display region left offset;
        s32                     display_width;			//* display region width;
        s32                     display_height;			//* display region height;
        ...
        s64                     pts;                    //* presentation time stamp, in unit of milli-second;
        s64                     pcr;                    //* program clock reference;
