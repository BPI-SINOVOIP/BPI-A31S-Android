...
typedef enum CEDARX_EVENT_TYPE{
	...
	CDX_EVENT_VIDEORENDERGETPERFORM,
...
typedef enum {
	//Add others or rename following format.
	CEDARX_OUTPUT_PIXEL_FORMAT_UNKOWN 	= 0,
	CEDARX_OUTPUT_PIXEL_FORMAT_YV12 	= 1,
	CEDARX_OUTPUT_PIXEL_FORMAT_NV21 	= 2,
	CEDARX_OUTPUT_PIXEL_FORMAT_MB32 	= 3,
}CEDARX_PIXEL_FORMAT;
...
typedef struct CedarXMediaInformations
{
    ...
    unsigned int  	_3d_mode;   //cedarv_3d_mode_e
...
typedef struct tag_ANativeWindowBufferCedarXWrapper //ANativeWindowBuffer
{
    ...
    const void *pBufferHandle;
    //To distinguish whether a new nativewindow is using.
    const void *pNativeWindow;
