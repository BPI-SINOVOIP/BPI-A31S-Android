...
public class WirelessSettings extends RestrictedSettingsFragment
    ...
    private PreferenceScreen mEthernetSettings;
    ...
    public WirelessSettings() {
        ...
        mFilter.addAction(EthernetManager.ETHERNET_INTERFACE_CHANGED_ACTION);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mEthernetSettings = (PreferenceScreen) findPreference(KEY_ETHERNET_SETTINGS);
    ...
    public void onResume() {
        if(!mEthManager.isEthIfExist())
            getPreferenceScreen().removePreference(mEthernetSettings);
        else
            getPreferenceScreen().addPreference(mEthernetSettings);
    ...
    private void handleEvent(Context context, Intent intent) {
        ...
        if (EthernetManager.ETHERNET_INTERFACE_CHANGED_ACTION.equals(action)) {
            final int event = intent.getIntExtra(EthernetManager.ETHERNET_INTERFACE_CHANGED_ACTION,
                    EthernetManager.ETHERNET_INTERFACT_REMOVED);
            switch(event) {
                case EthernetManager.ETHERNET_INTERFACT_ADDED:
                    getPreferenceScreen().addPreference(mEthernetSettings);
                    break;
                case EthernetManager.ETHERNET_INTERFACT_REMOVED:
                    getPreferenceScreen().removePreference(mEthernetSettings);
                    break;
                default:
                    break;
