...
#define kUSED_VIEW_ANGLE					"used_view_angle"
#define kHORIZONTAL_VIEW_ANGLE				"key_horizontal_view_angle"
...
public:
	...
	bool supportViewAngle();
	char * getHorizontalViewAngle();
	char * getVerticalViewAngle();
...
private:
	...
	char mUsedViewAngle[2];
	char * mHorizontalViewAngle;
	char * mVerticalViewAngle;
